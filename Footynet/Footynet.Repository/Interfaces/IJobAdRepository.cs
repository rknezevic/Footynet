...
public interface IJobAdRepository
{
    ...
    Task<IEnumerable<JobAdDto>> GetAllAsync(int page, int pageSize, PositionType? position, Guid? leagueId, string? searchTerm, Guid? excludePlayerId = null, bool sortDescending = true);
