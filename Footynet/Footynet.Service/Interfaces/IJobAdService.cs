...
public interface IJobAdService
{
    ...
    Task<IEnumerable<JobAdDto>> GetAllAsync(int page = 1, int pageSize = 10, PositionType? position = null, Guid? leagueId = null, Guid? countyId = null, string? searchTerm = null, Guid? excludePlayerId = null, bool sortDescending = true);
